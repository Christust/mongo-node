...
router.use("/maintenance_requirements", authenticateToken, maintenanceRequestRouter);
...
router.use("/material_requirements", authenticateToken, materialRequirementRouter);
